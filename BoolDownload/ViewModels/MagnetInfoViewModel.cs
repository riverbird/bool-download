...
/// <summary>“磁力链接下载信息”对话框的视图模型：展示磁力链接名称、包含的文件列表与保存位置。</summary>
public partial class MagnetInfoViewModel : ViewModelBase
{
    ...
    /// <summary>磁力链接内所有文件（含相对路径与大小）。</summary>
    public ObservableCollection<MagnetFileEntry> Files { get; } = new();

    public MagnetInfoViewModel()
    {
...
/// <summary>磁力链接内单个文件的信息。</summary>
public class MagnetFileEntry
{
